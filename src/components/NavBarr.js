    ...
    <nav className="navbar navbar-expand navbar-light navbar-bg">
          ...
          <i className="hamburger align-self-center"></i>
			  ...
			  <a class="nav-link dropdown-toggle  d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                <img src={currentUser.photoURL} class="avatar img-fluid rounded me-1" alt='' /> <span class="text-dark">{currentUser.displayName}</span>
              </a>
				...
				<div className="dropdown-menu dropdown-menu-end">
								...
								<div className="dropdown-divider"></div>
								<Link to='/signin' className="dropdown-item" onClick={()=>signOut(auth)}>Log out</Link>
							</div>
						</li>
					</ul>
				</div>
